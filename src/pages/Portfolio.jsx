              ...
              {investments.map((inv) => (
                <div key={inv.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center gap-3">
                    <span className={`text-xs font-medium px-2 py-1 rounded-full ${TYPE_COLORS[inv.type]}`}>
                      {inv.type}
                    </span>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => handleDelete(inv.id)} className="text-red-400 hover:text-red-600 text-xs">
                      ✕
                    </button>
                  </div>
                </div>
